👨‍💻 Guilherme Santos
🛡️ Cybersecurity | ⚙️ Automation | 💻 Developer fullstack
...
🚀 About Me
🎓 Cybersystems Technician student (SENAI — 2026)
🌎 Based in Brazil | Open to international opportunities
🔐 Focused on cybersecurity & ethical hacking
⚙️ Passionate about automation and real-world solutions
...
🚧 Roadmap
 ...
 Launch tech blog (cybersecurity + dev)
 Expand project portfolio
 Contribute to open source
⚠️ Note

Focused on ethical hacking and security best practices.
All knowledge is applied responsibly.

🌐 Sobre o Projeto

Este projeto é um site moderno e interativo que funciona como:

💼 Portfólio profissional
📄 Currículo online (Resume)
🧠 Base para blog técnico (em desenvolvimento)
📊 Dashboard com métricas do GitHub

A proposta foi criar uma experiência imersiva com estética cyberpunk, focando em performance, design e clareza de informações.

🧑‍💻 Sobre mim

Sou um técnico em Ciber Sistemas e desenvolvedor júnior baseado em Guarulhos, SP - Brasil.

Atualmente estudo no SENAI e tenho foco em:
...
🚧 Roadmap
 Implementar backend no formulário de contato
 Publicar artigos no blog técnico
